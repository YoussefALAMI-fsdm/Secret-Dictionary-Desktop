...
/**
 * Contrôleur pour le dialogue d'ajout d'antonyme
 */
public class AddAntonymeDialogController {

    private final MotServiceImp motService;
    private final MainController mainController;

    public AddAntonymeDialogController(MotServiceImp motService, MainController mainController) {
    ...
    public void show() {
        ...
        dialog.setTitle("⚡ Ajouter un antonyme");
        ...
        Label titre = new Label("Créer une relation d'antonymie");
        ...
        Label lblMot2 = new Label("📝 Deuxième mot (antonyme) *");
        ...
        dialog.setResultConverter(dialogButton -> {
            if (dialogButton == btnAjouter) {
                ...
                if (!mot1.isEmpty() && !mot2.isEmpty()) {
                    return ajouterAntonyme(mot1, mot2);
                }
            }
            return false;
        });
    ...
    /**
     * Ajoute la relation d'antonymie entre deux mots
     */
    private boolean ajouterAntonyme(String mot1, String mot2) {
        if (mot1.equalsIgnoreCase(mot2)) {
            afficherErreur("❌ Erreur", "Un mot ne peut pas être son propre antonyme !");
            return false;
        }
        ...
        int resultat = motService.addAntonyme(dto1, dto2);

        switch (resultat) {
            case 1:
                afficherSucces("✅ Antonyme ajouté",
                        "La relation d'antonymie entre '" + mot1 + "' et '" + mot2 + "' a été créée !");
                return true;
            case 0:
